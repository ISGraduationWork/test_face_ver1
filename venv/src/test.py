...
train_img_names = ["C:\\Users\\noraneko\\.vscode\\test_face_ver1\\venv\\screenshot_neko.png", ]
...
print(F"train_img_encodings:{train_img_encodings}")
print(F"test_img_encoding:{test_img_encoding}")
